...
parser.add_argument('--root_path', type=str, default='/content/drive/MyDrive/SemiSL/Dataset/PICAI_dataset', help='Name of Dataset')
...
def pre_train(args, snapshot_path):
    ...
    c_batch_size = 2
    trainset_lab_a = LAHeart(train_data_path, "/content/drive/MyDrive/SemiSL/Code/Basecode/Datasets/picai/data_split", split='train_lab', logging=logging)
    lab_loader_a = DataLoader(trainset_lab_a, batch_size=c_batch_size, shuffle=False, num_workers=0, drop_last=True)

    trainset_lab_b = LAHeart(train_data_path, "/content/drive/MyDrive/SemiSL/Code/Basecode/Datasets/picai/data_split", split='train_lab', reverse=True, logging=logging)
...
def self_train(args, pre_snapshot_path, self_snapshot_path):
    ...
    trainset_unlab_a = LAHeart(train_data_path, "/content/drive/MyDrive/SemiSL/Code/Basecode/Datasets/picai/data_split", split='train_unlab', logging=logging)
    unlab_loader_a = DataLoader(trainset_unlab_a, batch_size=c_batch_size, shuffle=False, num_workers=0, drop_last=True)

    trainset_unlab_b = LAHeart(train_data_path, "/content/drive/MyDrive/SemiSL/Code/Basecode/Datasets/picai/data_split", split='train_unlab', reverse=True, logging=logging)
...
if __name__ == "__main__":
    ## make logger file
    pre_snapshot_path = "/content/drive/MyDrive/SemiSL/trained_model/picai/SDCL/LA_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "/content/drive/MyDrive/SemiSL/trained_model/picai/SDCL/LA_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
    ...
    shutil.copy('/content/drive/MyDrive/SemiSL/Code/PICAI_SSL/Basecode/PICAI_train.py', self_snapshot_path)
    # -- Pre-Training
