...
class PICAIDataset(Dataset):
    ...
    def __init__(self, data_dir, list_dir, split, reverse=False, logging=logging):
        self.data_dir = data_dir  # No subfolder like 'Training Set'
        ...
        # Now files are named like: /path/to/data/10005/10005.h5
...
if __name__ == '__main__':
    ...
    list_dir = '/content/drive/MyDrive/SemiSL/Code/Basecode/Datasets/picai/data_split'
